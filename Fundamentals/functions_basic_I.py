...
def number_of_books_on_hold():
    return 5
    return 10
print(number_of_books_on_hold()) #5  //because it's the first return
...
def number_of_fingers():
    return 5
    print(10)
print(number_of_fingers()) #5 //because it's the first return
